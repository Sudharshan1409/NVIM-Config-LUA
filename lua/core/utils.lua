...
local mason_tools_config_function = function()
	...
	mason_tool_installer.setup({
		ensure_installed = mason_tools_ensure_installed,
	})
end
...
local lsp_config_function = function()
	...
	lsp_zero.on_attach(function(client, bufnr)
		...
		end, addDesc(opts, "LSP: Go to definition"))
		keymap("n", "K", function()
			vim.lsp.buf.hover()
		end, addDesc(opts, "LSP: Show hover"))
		keymap("n", "<leader>skw", function()
			vim.lsp.buf.workspace_symbol()
		end, addDesc(opts, "LSP: Search workspace symbols"))
		keymap("n", "gl", function()
			vim.diagnostic.open_float()
		end, addDesc(opts, "LSP: Open error in float"))
		keymap("n", "[", function()
			vim.diagnostic.goto_prev()
		end, addDesc(opts, "LSP: Go to previous error"))
		keymap("n", "]", function()
			vim.diagnostic.goto_next()
		end, addDesc(opts, "LSP: Go to next error"))
		keymap("n", "<leader>ca", function()
			vim.lsp.buf.code_action()
		end, addDesc(opts, "LSP: Code action"))
		keymap("n", "<leader>gr", function()
			vim.lsp.buf.references()
		end, addDesc(opts, "LSP: Find references"))
		keymap("n", "<leader>rn", function()
			vim.lsp.buf.rename()
		end, addDesc(opts, "LSP: Rename symbol"))
		keymap("i", "<C-h>", function()
			vim.lsp.buf.signature_help()
		end, addDesc(opts, "LSP: Signature help"))
...
return {
	...
	mason_tools_config_function = mason_tools_config_function,
}
